        ...
        "problems":
        {
          ...
          "problem_2": {
                ...
                "events": [
                  {
                    "time": EVENT_TIME_1,
                    "description": "Someone moved the clothes from living_room to the kitchen."
                  }
                ],
          ...
          "problem_4": {
                ...
                "events": [
                  {
                    "time": EVENT_TIME_1,
                    "description": "The clothes were moved from living_room to the kitchen."
                  },
                  {
                    "time": EVENT_TIME_2,
                    "description": "Someone took the clothes from the kitchen to the bedroom_1."
                  }
                ],
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "The mug was taken from the kitchen to the balcony."
                    }
                  ],
                  "goal": "Make a cup of coffee with the mug and bring it to Tom.",
                },
            ...
            "problem_4": {
                  ...
                  "events": [
                    ...
                    {
                      "time": EVENT_TIME_2,
                      "description": "Tom moved from the bedroom_1 to the balcony."
                    }
                  ],
                  "goal": "Make a cup of coffee with the mug and bring it to Tom.",
                },
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone brought the mop from bathroom_1 to the balcony."
                    }
                  ],
            ...
            "problem_3": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone used the mop to clean the balcony, leaving the mop dirty there."
                    }
                  ],
            ...
            "problem_4": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the cola_can from living_room to the kitchen."
                    },
                    {
                      "time": EVENT_TIME_2,
                      "description": "Someone used the mop to clean the balcony, leaving the mop dirty there."
                  ...
                  "goal": "Dispose the cola_can, banana_peel and rotting_apple, mop the floor in the living room.  Note the mop must be clean before mopping. After mopping, return the mop to where it was before it used in balcony. Ensure the mop is clean in the end and the agent is battery-full.",
                }
        }
      },
      "dining":
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone brought the plate from living_room to the kitchen."
                    }
                  ],
                  "goal": "Set up the dining table: place the plate, knife, fork, spoon, and glass on the dining table.",
                },
            "problem_3": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the flower from the lobby to the balcony."
                    }
                  ],
            ...
            "problem_4": {
                  ...
                  "events": [
                    ...
                    {
                      "time": EVENT_TIME_2,
                      "description": "Someone moved the flower from the bedroom_2 to the balcony."
                    }
                  ],
                  "goal": "Set up the dining table: place the plate, knife, fork, spoon, and glass on the dining table. Then put the flower back before it was moved to the balcony.",
                }
        }
      },
      "office":
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the lamp from bedroom_2 to the corridor_2."
                    }
                  ],
            ...
            "problem_3": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone opened the locker in the closet."
                    }
                  ],
            ...
            "problem_4": {
                  ...
                  "events": [
                    ...
                    {
                      "time": EVENT_TIME_2,
                      "description": "Someone moved the lamp from living_room to the corridor_2."
                    }
                  ],
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the ram from the kitchen to the corridor_1."
                    }
                  ],
                  "goal": "Bring all necessary PC components (mainboard, cpu, ram, ssd, gpu, psu) to the living room and assemble pc.",
                },
            "problem_3": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the ssd from bedroom_2 to the kitchen."
                    }
                  ],
            ...
            "problem_4": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the mainboard from bathroom_1 to the corridor_2."
                    },
                    {
                      "time": EVENT_TIME_2,
                      "description": "Someone moved the cpu from bedroom_1 to the kitchen."
                    }
                  ],
                  "goal": "Bring all necessary PC components (mainboard, cpu, ram, ssd, gpu, psu) to the living room and assemble pc.",
                }
