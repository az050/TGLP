        ...
        "problems":
        {
          ...
          "problem_2": {
                ...
                "events": [
                  {
                    "time": EVENT_TIME_1,
                    "description": "Someone moved the clothes from closet_1 to the kitchen."
                  }
                ],
          ...
          "problem_4": {
                ...
                "events": [
                  {
                    "time": EVENT_TIME_1,
                    "description": "The clothes were moved from closet_1 to the living_room."
                  },
                  {
                    "time": EVENT_TIME_2,
        ...
        "problems":
        {
            ...
            "problem_4": {
                  ...
                  "events": [
                    ...
                    {
                      "time": EVENT_TIME_2,
                      "description": "Tom moved from the bedroom_1 to the living_room."
                    }
                  ],
                  "goal": "Make a cup of coffee with the mug and bring it to Tom.",
                },
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone brought the mop from bathroom to the living_room."
                    }
                  ],
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone brought the plate from kitchen to bedroom_2."
                    }
                  ],
                  "goal": "Set up the dining table: place the plate, knife, fork, spoon, and glass on the dining table.",
                },
            "problem_3": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the flower from bedroom_1 to the living_room."
                    }
                  ],
            ...
            "problem_4": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone brought the flower from bedroom_1 to the bedroom_2."
                    },
                    {
                      "time": EVENT_TIME_2,
                      "description": "Someone moved the flower from the bedroom_2 to the living_room."
                    }
                  ],
                  "goal": "Set up the dining table: place the plate, knife, fork, spoon, and glass on the dining table. Then put the flower back before it was moved to the living_room.",
                }
        }
      },
      "office":
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the lamp from corridor_1 to the corridor_2."
                    }
                  ],
            ...
            "problem_3": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone opened the locker in the bedroom_1."
                    }
                  ],
            ...
            "problem_4": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the lamp from corridor_1 to the living_room."
                    },
                    {
                      "time": EVENT_TIME_2,
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the ram from the living_room to the corridor_1."
                    }
                  ],
                  "goal": "Bring all necessary PC components (mainboard, cpu, ram, ssd, gpu, psu) to the living room and assemble pc.",
                },
            "problem_3": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the ssd from the closet_1 to the kitchen."
                    }
                  ],
