      ...
      "laundry":
      {
        ...
        "problems":
        {
          "problem_1": {
                ...
                "events": [],
                "goal": "Launder the clothes and bring them to michaels_office.",
                },
          "problem_2": {
                ...
                "events": [
                  {
                    "time": EVENT_TIME_1,
                    "description": "Someone moved the clothes from michaels_office to the kitchen."
                  }
                ],
          ...
          "problem_3": {
                ...
                "events": [
                  {
                    "time": EVENT_TIME_1,
                    "description": "Someone turned the wash_machine on in the kitchen."
                  }
                ],
                "goal": "Launder the clothes and bring them to michaels_office.",
              },
          "problem_4": {
                ...
                "events": [
                  {
                    "time": EVENT_TIME_1,
                    "description": "The clothes were moved from michaels_office to the presentation_lounge."
                  },
                  {
                    "time": EVENT_TIME_2,
                    "description": "Someone took the clothes from the presentation_lounge to the michaels_office."
                  }
                ],
                "goal": "Launder the clothes and put clothes back where they were before they were moved to michaels_office.",
              }
        }
      },
      "human":
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "The mug was taken from nikos_office to the cafeteria."
                    }
                  ],
                  "goal": "Make a cup of coffee with the mug and bring it to Tom.",
                },
            ...
            "problem_4": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "The mug was moved from nikos_office to the presentation_lounge."
                    },
                    {
                      "time": EVENT_TIME_2,
                      "description": "Tom moved from meeting_room_1 to the cafeteria."
                    }
                  ],
                  "goal": "Make a cup of coffee with the mug and bring it to Tom.",
                },
      ...
      "clean":
      {
        "metadata":
        {
          ...
          [
            ...
            "clean_mop(<agent>, <item_1>, <item_2>, <room>): a simplified action schema of mop clean. For cleaning mop, <item_1> must be mop, mop is not-clean, <item_1> is accessible and has affordance pick. <item_2> must be sink andhave affordance clean_mop, <agent> and <item_2> should be in <room>, <agent> hold <item_1> in hand and has state hand-busy. As result, mop changes from not-clean to clean and is in <room>, agent no longer holds mop, agent state changes from hand-busy to hand-free, and agent battery changes from battery-full to battery-not-full.",
        ...
        "problems":
        {
            "problem_1": {
                  ...
                  "events": [],
                  "goal": "Dispose the cola_can, banana_peel and rotting_apple, mop the floor in presentation_lounge. Note that the mop should be clean before mopping room. Ensure the mop is clean in the end and the agent is battery-full.",
                  },      
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone brought the mop from kitchen to the cafeteria."
                    }
                  ],
                  "goal": "Dispose the cola_can, banana_peel and rotting_apple, mop the floor in the presentation_lounge. Must put the mop back where it originally was. Note that the mop should be clean before mopping room. Ensure the mop is clean in the end and the agent is battery-full.",
                },
            "problem_3": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone used the mop to clean the cafeteria, leaving the mop dirty there."
                    }
                  ],
                  "goal": "Dispose the cola_can, banana_peel and rotting_apple, mop the floor in the presentation_lounge. Note the mop must be clean before mopping. Ensure the mop is clean in the end and the agent is battery-full.",
                },
            "problem_4": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the cola_can from meeting_room_1 to the kitchen."
                    },
                    {
                      "time": EVENT_TIME_2,
                      "description": "Someone used the mop to clean the cafeteria, leaving the mop dirty there."
                  ...
                  "goal": "Dispose the cola_can, banana_peel and rotting_apple, mop the floor in the presentation_lounge.  Note the mop must be clean before mopping. After mopping, return the mop to where it was before it used in cafeteria. Ensure the mop is clean in the end and the agent is battery-full.",
                }
        }
      },
      "dining":
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone brought the plate from cafeteria to the kitchen."
                    }
                  ],
                  "goal": "Set up the dining table: place the plate, knife, fork, spoon, and glass on the dining table.",
                },
            "problem_3": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the flower from the lobby to the cafeteria."
                    }
                  ],
            ...
            "problem_4": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone brought the flower from the lobby to the manipulation_lab."
                    },
                    {
                      "time": EVENT_TIME_2,
                      "description": "Someone moved the flower from the manipulation_lab to the cafeteria."
                    }
                  ],
                  "goal": "Set up the dining table: place the plate, knife, fork, spoon, and glass on the dining table. Then put the flower back before it was moved to the cafeteria.",
                }
        }
      },
      "office":
      {
        ...
        "problems":
        {
            "problem_1": {
                  ...
                  "events": [],
                  "goal": "Set up a home office in the presentation_lounge by bringing the lamp, locker and shelf along with their contents. Unload contents first, move each container to the presentation_lounge, then reload the contents there. Note that you cannot move a loadable item if it is not empty!",
                  },
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the lamp from manipulation_lab to the corridor_3."
                    }
                  ],
                  "goal": "Set up a home office in the presentation_lounge by bringing the lamp, locker and shelf along with their contents. Unload contents first, move each container to the presentation_lounge, then reload the contents there. Note that you cannot move a loadable item if it is not empty!. After setting up, put the lamp back where it originally was.",
                },
            "problem_3": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone opened the locker in the meeting_room_1."
                    }
                  ],
                  "goal": "Set up a home office in the presentation_lounge by bringing the lamp, locker and shelf along with their contents. Unload contents first, move each container to the presentation_lounge, then reload the contents there. Note that you cannot move a loadable item if it is not empty! After setting up, ensure the locker is in its original state.",
                },
            "problem_4": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the lamp from manipulation_lab to the presentation_lounge."
                    },
                    {
                      "time": EVENT_TIME_2,
                      "description": "Someone moved the lamp from presentation_lounge to the corridor_3."
                    }
                  ],
                  "goal": "Set up a home office in the presentation_lounge by bringing the lamp, locker and shelf along with their contents. Unload contents first, move each container to the presentation_lounge, then reload the contents there. Note that you cannot move a loadable item if it is not empty!. After setting up, put the lamp back before it was moved to the presentation_lounge.",
                }
        }
      },
      "pc":
      {
        ...
        "problems":
        {
            "problem_1": {
                  ...
                  "events": [],
                  "goal": "Bring all necessary PC components (mainboard, cpu, ram, ssd, gpu, psu) to the presentation_lounge and assemble pc.",
                  },
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the ram from wills_office to the corridor_1."
                    }
                  ],
                  "goal": "Bring all necessary PC components (mainboard, cpu, ram, ssd, gpu, psu) to the presentation_lounge and assemble pc.",
                },
            "problem_3": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the ssd from peters_office to the kitchen."
                    }
                  ],
            ...
            "problem_4": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the mainboard from peters_office to the corridor_2."
                    },
                    {
                      "time": EVENT_TIME_2,
                      "description": "Someone moved the cpu from tobis_office to the kitchen."
                    }
                  ],
                  "goal": "Bring all necessary PC components (mainboard, cpu, ram, ssd, gpu, psu) to the presentation_lounge and assemble pc.",
                }
