        ...
        "problems":
        {
          ...
          "problem_2": {
                ...
                "events": [
                  {
                    "time": EVENT_TIME_1,
                    "description": "Someone moved the clothes from bedroom to the kitchen."
                  }
                ],
          ...
          "problem_4": {
                ...
                "events": [
                  {
                    "time": EVENT_TIME_1,
                    "description": "The clothes were moved from bedroom to the living_room."
                  },
                  {
                    "time": EVENT_TIME_2,
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "The mug was taken from the dining_room to the living_room."
                    }
                  ],
                  "goal": "Make a cup of coffee with the mug and bring it to Tom.",
                },
            ...
            "problem_4": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "The mug was moved from the dining_room to the living_room."
                    },
                    {
                      "time": EVENT_TIME_2,
                      "description": "Tom moved from the bedroom to the dining_room."
                    }
                  ],
                  "goal": "Make a cup of coffee with the mug and bring it to Tom.",
                },
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone brought the mop from corridor_1 to the dining_room."
                    }
                  ],
        ...
        "problems":
        {
            ...
            "problem_3": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the flower from corridor_1 to the dining_room."
                    }
                  ],
            ...
            "problem_4": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone brought the flower from corridor_1 to the living_room."
                    },
                    {
                      "time": EVENT_TIME_2,
                      "description": "Someone moved the flower from the living_room to the dining_room."
                    }
                  ],
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the lamp from bedroom to the corridor_2."
                    }
                  ],
            ...
            "problem_3": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone opened the locker in the bathroom."
                    }
                  ],
            ...
            "problem_4": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the lamp from bedroom to the living_room."
                    },
                    {
                      "time": EVENT_TIME_2,
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the ram from the dining_room to the corridor_1."
                    }
                  ],
                  "goal": "Bring all necessary PC components (mainboard, cpu, ram, ssd, gpu, psu) to the living room and assemble pc.",
                },
            "problem_3": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the ssd from the corridor_1 to the kitchen."
                    }
                  ],
            ...
            "problem_4": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the mainboard from kitchen to the corridor_2."
                    },
                    {
                      "time": EVENT_TIME_2,
                      "description": "Someone moved the cpu from bedroom to the kitchen."
                    }
                  ],
                  "goal": "Bring all necessary PC components (mainboard, cpu, ram, ssd, gpu, psu) to the living room and assemble pc.",
                }
