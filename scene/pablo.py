        ...
        "problems":
        {
          ...
          "problem_2": {
                ...
                "events": [
                  {
                    "time": EVENT_TIME_1,
                    "description": "Someone moved the clothes from bedroom to the corridor."
                  }
                ],
          ...
          "problem_3": {
                ...
                "events": [
                  {
                    "time": EVENT_TIME_1,
                    "description": "Someone turned the wash_machine on in the corridor."
                  }
                ],
                "goal": "Launder the clothes and bring them to bedroom.",
              },
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "The mug was taken from the living_room to the bedroom."
                    }
                  ],
                  "goal": "Make a cup of coffee with the mug and bring it to Tom.",
                },
            "problem_3": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone turned on the coffee machine in the living_room."
                    }
                  ],
                  "goal": "Make a cup of coffee with the mug and bring it to Tom.",
                },
            "problem_4": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "The mug was moved from the living_room to the bedroom."
                    },
                    {
                      "time": EVENT_TIME_2,
        ...
        "problems":
        {
            ...
            "problem_4": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the cola_can from the living_room to the bedroom."
                    },
                    {
                      "time": EVENT_TIME_2,
                      "description": "Someone used the mop to clean the living_room, leaving the mop dirty there."
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone brought the plate from living_room to the bedroom."
                    }
                  ],
                  "goal": "Set up the dining table: place the plate, knife, fork, spoon, and glass on the dining table.",
                },
            "problem_3": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the flower from the bedroom to the living_room."
                    }
                  ],
            ...
            "problem_4": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone brought the flower from the bedroom to the closet."
                    },
                    {
                      "time": EVENT_TIME_2,
                      "description": "Someone moved the flower from the closet to the living_room."
                    }
                  ],
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the lamp from bedroom to the corridor."
                    }
                  ],
            ...
            "problem_4": {
                  ...
                  "events": [
                    ...
                    {
                      "time": EVENT_TIME_2,
                      "description": "Someone moved the lamp from living_room to the corridor."
                    }
                  ],
        ...
        "problems":
        {
            ...
            "problem_2": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the ram from the living_room to the corridor."
                    }
                  ],
                  "goal": "Bring all necessary PC components (mainboard, cpu, ram, ssd, gpu, psu) to the living room and assemble pc.",
                },
            "problem_3": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the ssd from the corridor to the living_room."
                    }
                  ],
            ...
            "problem_4": {
                  ...
                  "events": [
                    {
                      "time": EVENT_TIME_1,
                      "description": "Someone moved the mainboard from bedroom to the corridor."
                    },
                    {
                      "time": EVENT_TIME_2,
                      "description": "Someone moved the cpu from living_room to the bedroom."
                    }
                  ],
                  "goal": "Bring all necessary PC components (mainboard, cpu, ram, ssd, gpu, psu) to the living room and assemble pc.",
                }
